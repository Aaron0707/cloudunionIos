...
@property (strong, nonatomic) NSURL *srcUserImageUrl;
...

{
    ...
    if (self) {
        ...
        _cruuentUser = [[BSEngine currentEngine] user];
        
        _srcUserImageUrl= [[NSURL alloc]initWithString:_cruuentUser.avatar];
...
{
        UIButton *lefBtn = (UIButton *)[self.navigationItem leftBarButtonItem].customView;
    [lefBtn removeTarget:self action:@selector(popoverController) forControlEvents:UIControlEventTouchUpInside];
        [lefBtn addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    ...
    if (indexPath.row < [self.dataSource count]) {
        ...
        if ([obj isKindOfClass:[NSString class]]) {
            ...
            if (model.isSender) {
                ...
                model.headImageURL = _srcUserImageUrl;
                
            }else{
                
                model.headImageURL = _tergatUserImageUrl;
...
- (void)moreViewAudioCallAction:(DXChatBarMoreView *)moreView
{
    ...
    [callController setHeaderImage:[UIImage imageWithData:[NSData dataWithContentsOfURL:_tergatUserImageUrl]]];
    [callController setNameLabel:_cruuentUser.ownerName];
